...
ActiveRecord::Schema.define(version: 20150721095419) do
  ...
  create_table "schedule_dates", force: :cascade do |t|
    ...
    t.string   "repeating_every",       default: "--- {}\n"
    ...
    t.datetime "created_at",                                 null: false
    t.datetime "updated_at",                                 null: false
    t.integer  "repeating_every_month"
    t.integer  "repeating_every_day"
    t.integer  "program_id"
  end

  add_index "schedule_dates", ["program_id"], name: "index_schedule_dates_on_program_id"
